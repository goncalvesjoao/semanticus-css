export const RoleTooltipDemoArgs = {
  syntax: `<p>Tooltip on a <span><a href="#" aria-describedby="tip-link">link</a><span id="tip-link" role="tooltip" data-placement="right">Tooltip</span></span></p>
...
export const RoleTooltipDemo = {
  syntax() {
    return RoleTooltipDemoArgs.syntax;
  },
  placement() {
    return RoleTooltipDemoArgs.placement;
  },
};
