...
${FooterDemo.default({ class: footerClass })}`
  ...
  withHeaderPlusFooter(args: MainDemoArgsType & { headerClass?: string, footerClass?: string } = {}) {
...
${FooterDemo.default({ class: footerClass })}`
  ...
  withHeaderPlusArticle(args: MainDemoArgsType & { articleClass?: string, headerClass?: string } = {}) {
...
${ArticleDemo.default({ class: articleClass })}`
  ...
  withArticlePlusFooter(args: MainDemoArgsType & { articleClass?: string, footerClass?: string } = {}) {
...
${FooterDemo.default({ class: footerClass })}`
  ...
  withHeaderPlusArticlePlusFooter(args: MainDemoArgsType & { articleClass?: string, headerClass?: string, footerClass?: string } = {}) {
